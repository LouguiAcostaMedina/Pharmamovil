    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Aquí se gestionará el registro, consulta y directorio de clientes farmacéuticos.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    textAlign = TextAlign.Center
                )
    ...
    Box(
        ...
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Aquí se administrarán las solicitudes, despachos y estado de pedidos de medicamentos.",
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.onSurfaceVariant,
                    textAlign = TextAlign.Center
                )
